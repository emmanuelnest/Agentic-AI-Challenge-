...
Execute comprehensive validation tests for the frontend application, returning results in a standardized JSON format for automated processing.
...
- Identify linting issues or code quality problems
...
1. **TypeScript Type Check**
   ...
   - test_purpose: "Validates TypeScript type correctness and compilation, catching type errors, missing imports, and incorrect function signatures"
