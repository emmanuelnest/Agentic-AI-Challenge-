...
- If you need a new library, use `npm install` or `yarn add` and be sure to report it in the `Notes` section of the `Plan Format`.
- Keep components simple and functional. Use React hooks for state management.
